...
const config: Config = {
  ...
  url: 'https://binarymath.dw.cash/', // Replace 'auric' with actual GitHub username
  ...
  projectName: 'the-binarymath', // Repository name
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/loning/the-binarymath/tree/main/',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub',
              href: 'https://github.com/loning/the-binarymath',
            },
          ],
        },
      ],
